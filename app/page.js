    ...
    <div className="min-h-screen bg-gray-50 pb-20 font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-4 mt-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6">
          {[{url: '/', icon: '🏠', title: 'Home', desc: 'Kembali ke beranda'}, {url: '/daily-activity', icon: '📝', title: 'Activity', desc: 'Isi form harian'}, {url: '/academy', icon: '🎓', title: 'Academy', desc: 'Modul belajar'}, {url: '/events', icon: '🗓️', title: 'Events', desc: 'Jadwal Training'}, {url: '/contest', icon: '🏆', title: 'Contest', desc: 'Lihat kontes'}].map(menu => (
